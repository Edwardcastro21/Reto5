...
import Edward.Reto32.Modelo.Reservaciones;
import Edward.Reto32.Modelo.StatusReservas;
import Edward.Reto32.Service.ServiceReservaciones;
...
public class ReservacionesWeb {
      @Autowired
    private ServiceReservaciones servicio;
    @GetMapping("/all")
